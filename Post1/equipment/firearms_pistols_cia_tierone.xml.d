<Equipment>
	...
	<Bind eqp="VP9 Pistol CIA BOps_TierOne">
		<to name="Undercover"/>
		<to name="BlackOps"/>
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	...
	<Firearm name="VP9 Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeapon" category="pistol" unlockCost="6"
	...
	<Bind eqp="G19Custom Pistol CIA BOps_TierOne">
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	</Bind>

	<Firearm name="G19Custom Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeapon" category="pistol" unlockCost="6"
	...
	<Bind eqp="G19XSD Pistol CIA BOps_TierOne">
		<to name="Undercover"/>
		<to name="BlackOps"/>
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	...
	<Firearm name="G19XSD Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeaponMuzzle" category="pistol" unlockCost="6"
	...
	<Bind eqp="G17 Pistol CIA BOps_TierOne">
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	</Bind>

	<Firearm name="G17 Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeapon" category="pistol" unlockCost="0"
	...
	<Bind eqp="G2240SD Pistol CIA BOps_TierOne">
		<to name="Undercover"/>
		<to name="BlackOps"/>
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	...
	<Firearm name="G2240SD Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeaponMuzzle" category="pistol" unlockCost="6"
	...
	<Bind eqp="M18 Pistol CIA BOps_TierOne">
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	</Bind>

	<Firearm name="M18 Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeapon" category="pistol" unlockCost="2"
	...
	<Bind eqp="HK45CTSup CIA BOps_TierOne">
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	</Bind>

	<Firearm name="HK45CTSup CIA BOps_TierOne" inventoryBinding="SecondaryWeaponMuzzle" category="pistol" unlockCost="0"
	...
	<Bind eqp="1911 Pistol CIA BOps_TierOne">
		<to name="DEVUndercover"/>
		<to name="DEVBlackOps"/>
	</Bind>

	<Firearm name="1911 Pistol CIA BOps_TierOne" inventoryBinding="SecondaryWeapon" category="pistol" unlockCost="5"
